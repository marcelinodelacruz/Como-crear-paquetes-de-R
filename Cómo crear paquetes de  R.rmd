...
=======
[encosing_issues]: https://cloud.r-project.org/doc/manuals/r-release/R-exts.html#Encoding-issues
[tutorial]: https://kbroman.org/pkg_primer/
[github_nota]: https://github.com/marcelinodelacruz/Como-crear-paquetes-de-R
...
# Originalmente jugando con citep() escribimos las referencias
# en references.bib y/o knitcitations.bib
#write.bibtex(file = "knitcitations.bib")
<<<<<<< Updated upstream
write.bibtex(file = "references.bib", append=TRUE)
=======
#write.bibtex(file = "references.bib", append=FALSE)
>>>>>>> Stashed changes
```
