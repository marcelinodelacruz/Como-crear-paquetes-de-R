...
El siguiente paso es añadir el código que queremos incluir en nuestro paquete. Siguiendo con nuestro ejemplo, nos gustaría que nuestro `paqueteR` incluya dos funciones, `sqrtfun1()`:
